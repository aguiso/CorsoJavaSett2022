			...
			<section class="content">
				...
				<div class="container">
					<div class="row">
						<div class="col"></div>
						<div class="col">
							<form action="searchAuto" method="POST" modelAttribute="requestSearchAuto">
								<div class="form-row">
									<div class="form-group col-md-6">
										<label for="id">ID</label> <input type="number"
											class="form-control" id="id" name="id" path="id" placeholder="ID Auto">
									</div>
									<div class="form-group col-md-6">
										<label for="targa">Targa</label> <input type="text"
											class="form-control" id="targa" name="targa" path="targa" placeholder="Targa">
									</div>
								</div>
								<div class="form-group">
									<label for="costruttore">Costruttore</label> <select
										id="costruttore" id="costruttore" name="costruttore" path="costruttore" class="form-control">
								...
								<div class="form-group">
									<label for="modello">Modello</label> <input type="text"
										class="form-control" id="modello" name="modello" path="modello" placeholder="Modello">
								</div>
								<div class="form-row">
									<div class="form-group col-md-6">
										<label for="alimentazione">Alimentazione</label> <input
											type="text" class="form-control" id="alimentazione" name="alimentazione" path="alimentazione"
											placeholder="Alimentazione">
									</div>
									<div class="form-group col-md-6">
										<label for="annoCostruzione">Anno Costruzione</label> <input
											type="number" class="form-control" id="annoCostruzione" name="annoCostruzione" path="annoCostruzione"
								...
								<div class="form-row">
									<div class="form-group col-md-6">
										<label for="costo">Costo</label> <input type="number"
											class="form-control" id="costo" name="costo" path="costo" placeholder="Costo">
									</div>
									<div class="form-group col-md-6">
										<label for="colore">Colore</label> <select id="colore" name="colore" path="colore"
											class="form-control">
								...
								<button style="text-align: center" type="submit" id="search" name="search" path="search"
									class="btn btn-warning">Search Auto</button>
							</form>
						</div>
						<div class="col"></div>
					</div>
